...
By implementing CAT control support, SDRLoggerPlus can automatically detect connected radios on the local network, monitor their frequency and mode in real-time, and pre-populate logging fields accordingly.
...
#### FlexRadioService.cs
```
Location: src/SDRLoggerPlus.Server/Services/FlexRadioService.cs
Responsibilities:
...
#### TciRadioService.cs
```
Location: src/SDRLoggerPlus.Server/Services/TciRadioService.cs
Responsibilities:
...
#### RadioHub.cs (SignalR)
```
Location: src/SDRLoggerPlus.Server/Hubs/RadioHub.cs
```
...
#### RadioPlugin.tsx
```
Location: src/SDRLoggerPlus.Web/src/plugins/radio/RadioPlugin.tsx
Features:
- Radio type selector
...
#### useRadioHub.ts
```
Location: src/SDRLoggerPlus.Web/src/hooks/useRadioHub.ts
Features:
