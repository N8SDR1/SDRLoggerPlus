...
1. **Port Number Mismatch** ⚠️ **PRIMARY ISSUE**
   - SDRLoggerPlus uses port **50001** (line 27 in `TciRadioService.cs`)
...
### 🎯 SDRLoggerPlus's Implementation is Multi-Client Compatible
...
- [ ] Connect SDRLoggerPlus to TCI
- [ ] Verify SDRLoggerPlus shows "Connected"
...
**The good news:** TCI fully supports multiple simultaneous connections. SDRLoggerPlus's implementation is compatible with this design.

**The fix:** A simple port number correction (50001 → 40001) should resolve the reported issue and align SDRLoggerPlus with the TCI standard.

**The benefit:** Users will be able to run SDRLoggerPlus alongside StationMaster, JTDX, and other TCI applications without conflicts.
