...
Based on the OpenHamClock implementation (which solved the same issue), we updated SDRLoggerPlus to use the correct endpoint.
...
**File**: `src/SDRLoggerPlus.Server/Controllers/PotaController.cs`
...
OpenHamClock implements several additional robustness features that SDRLoggerPlus could consider:
