...
SDRLoggerPlus currently provides:
...
1. User opens SDRLoggerPlus after a weekend of operating
...
- Consistent with SDRLoggerPlus color scheme and typography
...
**StatisticsController** (`/src/SDRLoggerPlus.Server/Controllers/StatisticsController.cs`)
...
**AwardsService** (`/src/SDRLoggerPlus.Server/Services/AwardsService.cs`)
...
**ConfirmationService** (`/src/SDRLoggerPlus.Server/Services/ConfirmationService.cs`)
...
**DxccStatistics** (`/src/SDRLoggerPlus.Contracts/Api/StatisticsDto.cs`)
```csharp
...
**File:** `/src/SDRLoggerPlus.Web/src/plugins/StatisticsPlugin.tsx`
...
**File:** `/src/SDRLoggerPlus.Web/src/api/client.ts`
...
**Zustand Store:** `/src/SDRLoggerPlus.Web/src/store/statisticsStore.ts`
...
6. Visual design is consistent with SDRLoggerPlus theme
...
- **Leaderboards:** Compare progress with other SDRLoggerPlus users
...
### 13.4 SDRLoggerPlus Architecture
