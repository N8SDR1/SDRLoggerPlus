...
1. .NET backend: `cd src/SDRLoggerPlus.Server && ASPNETCORE_URLS=http://localhost:<backend_port> dotnet run`
2. Vite frontend: `cd src/SDRLoggerPlus.Web && BACKEND_PORT=<backend_port> npm run dev -- --port <frontend_port>`
