...
import { Bot, BotMessageSquare, Send, RefreshCw, Settings, Loader2, Key, Calendar, MessageCircleQuestion } from 'lucide-react';
...
export function ChatAiPlugin() {
  ...
  if (!hasApiKey) {
    return (
      <GlassPanel title="Chat AI" icon={<BotMessageSquare className="w-5 h-5" />}>
        <div className="p-4 h-full flex flex-col items-center justify-center">
          ...
          <p className="text-sm text-gray-500 text-center mb-6 max-w-md">
            ...
            <br />
            <br />
            Your key is stored locally and never sent to SDRLoggerPlus servers.
          </p>
          <button
        ...
        <div className="p-4 h-full flex flex-col">
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              <BotMessageSquare className="w-16 h-16 text-gray-600 mx-auto mb-4" />
